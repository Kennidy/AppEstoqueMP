...
import br.dev.kgb.mobile.estoquemp.ui.produto.placeholder.PlaceholderContent.PlaceholderItem;
...
public class ConProdutoRecyclerViewAdapter extends RecyclerView.Adapter<ConProdutoRecyclerViewAdapter.ViewHolder> {
    ...
    public ConProdutoRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
